...
* Focus goes to "skip to content" button when dialog closes
...
* Removed templates (e.g. innerHTML) to create dialogs and menu button.  This is needed for the
  ...
  use of templates.
* Internationalization configuration for About and Shortcuts dialog boxes
...
* Added hide "Skip To Content" button to static rendering option, for people to remove
  the button, a cookie is used to make the setting persistent for the current window

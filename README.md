...
NOTE: A CSS stylesheet can also be used to style the button and menu by using the appropriate elements, ids and classes in the generated by the script as selectors, more information in a later section.

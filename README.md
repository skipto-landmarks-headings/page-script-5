...
A simple Javascript configuration object can be used to override default colors and typography.  CSS values can be used for the colors and font information.

**NOTE:** A CSS stylesheet can also be used to style the button and menu by using the appropriate element and class selectors.  There is more information about the HTML generated by the script in a later section.
...
For websites at the University of Illinois you can get the default Illinois colors using the "colorTheme" option.
